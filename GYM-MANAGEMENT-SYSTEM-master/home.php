...
<body style="background:url(5.jpg);">
  ...
  <a class="navbar-brand" href="home.php">CULT-FIT MANAGEMENT SYSTEM</a>
  ...
  <div class="col-2">
    ...
    <div class="list-group">
      ...
      <div id="collapseTwo" class="collapse" data-parent="#accordion">
          <div class="list-group-item" style="background-color: #303030;"><a href="home.php?info=add_gym" class="text-light">ADD BRANCH</a>
          </div>
          <div class="list-group-item" style="background-color: #303030;"><a href="home.php?info=manage_gym" class="text-light">VIEW BRANCH</a></div>
        </div>
      <div class="list-group-item bg-dark">
